...
class DataProcessor(object):
    ...
    def _read_data(cls,input_file):
        ...
        for line in rf:
            ...
            if len(line.strip())==0: #修正箇所 and words[-1] == '.':
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        :return:
        """
        return ["[PAD]","B-F","B-T","B-D","B-Q","B-Ac","B-Af","B-Sf","B-St","I-F","I-T","I-D","I-Q","I-Ac","I-Af","I-Sf","I-St", "O", "X","[CLS]","[SEP]"]
...
def Writer(output_predict_file,result,batch_tokens,batch_labels,id2label):
    with open(output_predict_file,'a') as wf:
